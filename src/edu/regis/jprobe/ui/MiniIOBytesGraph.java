 ...
 *
 */
public class MiniIOBytesGraph extends MiniDynamicGraph {
    ...
    private static String title = "I/O Bytes";
    /**
     * @param numberOfSamples
     * @param seriesLegendName
     * @param chartName
     */
    public MiniIOBytesGraph(int numberOfSamples) {
    ...
    public void addObservation(double read, double write, double other) {
        ...
        setTitle(title + " (" + Utilities.formatBytes((long)total) + ")");
    }
