...
public class AttributeCellRenderer implements TableCellRenderer, TableCellEditor {
    ...
    public AttributeCellRenderer(JPanel parent, 
    ...
    private Component renderComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        if (value == null) {
            ...
            tf.setToolTipText("This attribute returned a null reference");
            if (writeable){
        ...
        if (value instanceof String) {
            ...
            if (value.toString().equals("<Not Serializable>")) {
                ...
                writeable = false;
            } else if (value.toString().equals("<Unavailable>")) {
                tf.setForeground(Color.red);
                tf.setToolTipText("An Exception Occurred Obtaining this Attribute, See the Error" + 
                        " log for details");
        ...
        if (value instanceof Number) {
            ...
            if (value != null && value instanceof Long) {
                ...
                if (val > 0) {
                    tf.setToolTipText("DateTime(" +
                            Utilities.formatTimeStamp(val, "MM/dd/yyyy HH:mm:ss.SSS") +
                            ")");
                }
            }
        ...
        if (valClass.isArray()) {
               ...
               if (len == 0) {
                   ...
                   f.setEditable(false);
                   f.setToolTipText("This is an empty Array");
                   return f;
               }
        ...
        if (value instanceof Map) {
            if (((Map<?,?>)value).isEmpty()) {
                ...
                f.setForeground(Color.BLUE);
                f.setEditable(false);
                f.setToolTipText("This is an empty Map");
                return f;
            }
        ...
        if (value instanceof Collection) {
            if (((Collection<?>)value).isEmpty()) {
                ...
                f.setForeground(Color.BLUE);
                f.setEditable(false);
                f.setToolTipText("This is an empty Collection");
                return f;
            }
