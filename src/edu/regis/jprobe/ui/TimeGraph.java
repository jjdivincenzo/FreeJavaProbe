...
public class TimeGraph extends JPanel {
     ...
     */
    public TimeGraph(int i, String series1LegendName, String series2LegendName,
            String axisName, String chartName, Color s1Color, Color s2Color)
    {
        super(new BorderLayout());
        
        series1 = new TimeSeries(series1LegendName, org.jfree.data.time.Second.class);
        series1.setMaximumItemCount(i);
        //series1.setHistoryCount(i);
        series2 = new TimeSeries(series2LegendName, org.jfree.data.time.Second.class);
        //series2.setHistoryCount(i);
        series2.setMaximumItemCount(i);
        ...
        xylineandshaperenderer.setSeriesPaint(1, s2Color);
     ...
     */
    public void addTotalObservation(double value, double value2, long thisInterval)
    {
        if (lastTime == 0) {
        ...
        series2.addOrUpdate(period, value2);
    }
    ...
    public void setSampleSize(int val) {
       	...
       	series2.setMaximumItemCount(val);
