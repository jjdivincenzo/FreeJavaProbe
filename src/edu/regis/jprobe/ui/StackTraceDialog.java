...
public class StackTraceDialog extends JDialog {
	...
	public StackTraceDialog(Frame parent, String stack) { 
		...
		setTitle("Stack Trace for all Threads");		
		...
		Font fontTF = stackTrace.getFont();
		fontTF = fontTF.deriveFont(Font.BOLD);
		stackTrace.setFont(fontTF);
	...
	public static void main(String args[]) {
		...
		new StackTraceDialog(null, "text"); 
